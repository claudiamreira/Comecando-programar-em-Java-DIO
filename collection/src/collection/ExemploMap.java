...
public class ExemploMap {
	...
	public static void main(String[] args) {
		...
		System.out.println("\nConfira se o modelo tucson está no dicionário: " + carrosPopulares.containsKey("tecson"));
		...
		System.out.println(modeloEconomico + " - " + melhorConsumo);
		...
		for(Map.Entry<String, Double> entry : carrosPopulares.entrySet()) {
			if(entry.getValue().equals(piorConsumo)) modeloMenosEconomico = entry.getKey();
		}
		System.out.println(modeloMenosEconomico + " - " + piorConsumo);
